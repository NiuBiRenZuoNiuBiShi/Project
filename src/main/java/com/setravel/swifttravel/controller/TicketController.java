...
public class TicketController {
    ...
    public Result getCarriages(@RequestParam(required = false) String depStation,
            @RequestParam(required = false) String depCity, @RequestParam(required = false) String arrStation,
            @RequestParam(required = false) String arrCity, @RequestParam String depDate) {
        List<CarriageThrough> carriageThrough = carriagesService.getCarriageThrough(depStation, depCity, arrStation,
                arrCity, depDate);
    ...
    public Result getCarriagesTransfer(@RequestParam String depCity, @RequestParam String arrCity,
    ...
    public Result getCarriagesByType(@RequestParam String depStation, @RequestParam String depCity,
        ...
        return new Result(200, "成功获取到" + type + "类型车", carriagesService.getCarriageType(type,
                carriagesService.getCarriages(depStation, depCity, arrStation, arrCity, depDate)));
    }
